...
print ga.red+'''
	  ...
	  \ \        / / | |   |  ____|______ _______              |___ \      
	   \ \  /\  / /__| |__ | |____|  ____|_____  |_ __    _ __   __) |_ __ 
	    \ \/  \/ / _ \ '_ \|____  | |     _____| | '_ \  | '_ \ |__ <| '__|
 	     \  /\  /  __/ |_) |____| | |____|  __   | | | | | | | |___) | |   
 	      \/  \/ \___|_.__/|______|______|_______|_| |_| |_| |_|____/|_|   
                                                    
        ##############################################################
        #| "WebScanner" Web Applications Security Scanner            #
        #|  By Mr.XxX - @Cyber Error System Team                     #
        #|  This Version Supports Remote Code/Command Execution, XSS #
        #|  And SQL Injection.                                       #
	#|  Owner Mr.XxX, ./M1N4T0, ./Kiddrock, ./XMONDARDO          #
